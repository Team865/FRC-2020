...
import static ca.warp7.frc2020.Constants.kBeamBreakerID;
...
public final class Feeder implements Subsystem {
    ...
    private DigitalInput beamBreaker = new DigitalInput(kBeamBreakerID);
    ...
    public void indexPowerCell(){
        feederOuter775.set(ControlMode.PercentOutput, Constants.kIndexSpeed);
    }
}
